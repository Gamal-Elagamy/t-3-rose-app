...
import useDeleteAccount from '../../hooks/account-settings/use-delete-account';
  ...
  >
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-4 sm:gap-6">
        <X
          onClick={closeModel}
          className="size-6.5 self-end cursor-pointer text-ds-text-soft"
        />
        ...
        <div className="flex flex-col items-center justify-center gap-2.5 text-center">
          {/* Title */}
          <h3 className="text-lg font-semibold text-ds-text-plain sm:text-xl">
            {t('title')}
          </h3>

          {/* Description */}
          <p className="text-sm font-normal text-maroon-500 sm:text-base">
            {t('description')}
          </p>
        </div>
      </div>
