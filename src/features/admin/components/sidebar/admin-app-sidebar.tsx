...
export default async function AdminAppSidebar({ user }: { user: IUser }) {
  ...
  return (
    <Sidebar
      ...
      collapsible="icon"
      className="border-none bg-white dark:bg-zinc-800"
    >
      <SidebarHeader>
      ...
      <SidebarContent className="p-4">
        <Link
          href={'/'}
          className={
            'w-full flex items-center justify-center gap-3 px-2.5 py-1.5 rounded-lg bg-maroon-600 hover:bg-maroon-700 dark:bg-ds-bg-primary text-white dark:text-black font-semibold'
          }
        >
